 ...
 * pnpm add -wD typescript eslint prettier eslint-plugin-prettier eslint-plugin-sort-exports eslint-plugin-react @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint-plugin-import eslint-import-resolver-typescript
...
module.exports = {
  ...
  settings: {
    react: { version: 'detect' }, // detect solved the annoying warning of: "React version not specified in eslint-plugin-react settings"
  ...
  rules: {
    ...
    'import/no-unresolved': [
      'error',
      { ignore: ['.css$', '^@site', '^@theme', '^@docusaurus', '^@generated', 'unist', 'mdast'] },
    ], // Turns on errors for missing imports. # import/no-unresolved: [2, { commonjs: true, amd: true }] // This rules catches unresolved imports, but you don't need it since typescript also catches unresolved imports.
    ...
    'import/extensions': ['error', 'never', { js: 'always', css: 'always', svg: 'always' }],
